...
public class ItemTest {
    ...
    public void getItemId() {
        int itemId = 123;
        Item item = new Item(itemId, "bottle", "HpBottle",0);
    ...
    public void getItemName() {
        ...
        Item item = new Item(123, itemName, "HpBottle",0);
    ...
    public void getType() {
        ...
        Item item = new Item(123, "bottle", itemType,0);
    ...
    public void getHpBottleHashMap() {
        Item item = new Item(123, "bottle", "HpBottle",0);
    ...
    public void getAtkBottleHashMap() {
        Item item = new Item(123, "bottle", "AtkBottle",30);
    ...
    public void getDefBottleHashMap() {
        Item item = new Item(123, "bottle", "DefBottle",20);
    ...
    public void getEquipmentHashMap() {
        Item item = new Item(123, "equip", "Equipment",30);
        HashMap<Integer, Equipment> equipmentHashMap = item.getEquipmentHashMap();
        Equipment equipment = new Equipment(456, "equip2", 25, "Axe", 30);
